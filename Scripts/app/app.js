var app = angular.module('App', ['dataService']).
  ...
  config(['$routeProvider', function ($routeProvider){
    ...
    $routeProvider.
      ...
      when('/credential/new', { templateUrl: 'Scripts/templates/_edit.html', controller: 'EditCtrl' }).
      when('/credential/:credentialId', { templateUrl: 'Scripts/templates/_detail.html', controller: 'DetailCtrl' }).
      when('/credential/:credentialId/edit', { templateUrl: 'Scripts/templates/_edit.html', controller: 'EditCtrl' }).
